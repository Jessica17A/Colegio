    ...
    success: function (data) {
      ...
      data.forEach(u => {
        ...
        html += `<tr>
          ...
          <td>
           <button class="btn btn-sm btn-warning me-1" title="Resetear contraseña"
                  onclick="abrirModalReset(${u.ID_USUARIO})">
              <i class="fas fa-edit"></i>
          </button>

            <button class="btn btn-sm btn-${estadoActivo ? 'danger' : 'success' }" title="${estadoActivo ? 'Desactivar' : 'Activar'} usuario"
